...
pruned_green_cab$dropoff_hour <- (as.numeric(strptime(pruned_green_cab$lpep_dropoff_datetime, "%m/%d/%Y %l:%M:%S %p")) - as.numeric(strptime("01/01/2018 12:00:00 AM", "%m/%d/%Y %H:%M:%S %p"))) %/% 3600
...
write.csv(pruned_green_cab, file = "../Data/pruned_green_cab.csv",row.names=FALSE, na="")
```
