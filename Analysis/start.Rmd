...
names(a) <- c("PickupHour", "RatecodeID", "PULocationID", "DOLocationID", "PassengerCount", "TripDistance", "FareAmount", "Extra", "MtaTax", "TipAmount", "TollsAmount", "ImprovementSurcharge", "TotalAmount", "PaymentType", "TripType", "DropoffHour", "TripDuration", "HourlyDewPointTemperature","HourlyPrecipitation", "HourlyWindSpeed", "Weekday", "N")
```
